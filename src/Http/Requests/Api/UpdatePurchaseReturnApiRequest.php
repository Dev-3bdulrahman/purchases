...
class UpdatePurchaseReturnApiRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'purchase_order_id' => 'sometimes|required|exists:purchases_orders,id',
            'supplier_invoice_id' => 'nullable|exists:purchases_supplier_invoices,id',
            'return_number' => 'sometimes|required|string|max:255',
