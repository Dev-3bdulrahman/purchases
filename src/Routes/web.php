...
Route::middleware(['web', 'auth', 'role:super-admin|developer|admin|employee', 'license'])
    ...
    ->group(function () {
        ...
        Route::get('/purchases/goods-receipt', \Dev3bdulrahman\Purchases\Http\Controllers\Web\Admin\GoodsReceipt\Index::class)->name('admin.purchases.goods-receipt');
        Route::get('/purchases/matching', \Dev3bdulrahman\Purchases\Http\Controllers\Web\Admin\Matching\Index::class)->name('admin.purchases.matching');
    });
